...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--inter_file", type=str, default=".inter.json", help="the interaction data between items and users")
...
def parse_test_args(parser):
    ...
    parser.add_argument("--results_detail_file", type=str, default="./results/test_detail_ddp.json", help="detailed result output path")
